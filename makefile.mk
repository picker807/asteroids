...
#     Aaron Picker
# Summary:
#     This is classic Asteroids, almost. Game emulates Asteroids with a laser-shooting ship and
#		deadly space rocks. It's kill or be killed.
# Above and Beyond
#     I added a score, extra lives (with life icons), and game over banner. More Big rocks appear if the screen is cleared.
###############################################################
